...
export class InputFormComponent implements OnInit {
  ...
  @ViewChild('dynamicAddItem', {static: true}) private scrollDiv: ElementRef;
  ...
  trigeerTrailNotification () {
    this._snakebar.open('Only printing is disabled for free version to get printing enable contact your application provider. ', 'Dissmis', {duration: this._appSettings.notificationDuraton * 1000});
  }
