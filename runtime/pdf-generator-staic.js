...
function generateInvoiceTable(doc, bill, config) {
    ...
    generateTableRow(doc, invoiceTableTop, 'Item', 'Price', 'Quantity', 'Discount', 'Total');
    ...
    for (i = 0; i < bill.itemsPurchased.length; i++) {
        ...
        generateTableRow(doc, position, item.itemName, item.itemPrice, item.itemQuantity, item.itemDiscount, (item.itemPrice - item.itemDiscount) * item.itemQuantity);
...
exports.getPdfCommandStatic = getPdfCommandStatic;
//# sourceMappingURL=pdf-generator-staic.js.map